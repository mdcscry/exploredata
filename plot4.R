...
x <- erg10$datefix <- strptime(paste(erg10[,1], erg10[,2]), "%d/%m/%Y %H:%M:%S")
erg10[,2] <- NULL
erg10[,1] <- NULL
...
#PLOT 4
plot (erg10$datefix,erg10[,3],type="l",ylab="Voltage",
      xlab="datetime")

#PLOT 5
plot (erg10$datefix,erg10[,2],type="l",ylab="Global_reactive_power",
      xlab="datetime")
